...
public class gamePageController implements Initializable {
    ...
    public void updateResearchPanel (){
        ...
        try {
            currentResearchImageView.setImage(
                    new Image(
            ...
            currentResearchImageView.setImage(
                    new Image(
                            Main.class.getResource("/game/images/technologies/Agriculture.png").toExternalForm()
                    )
            );
        }
    ...
    public void updateSelectedUnitPanel (){
        ...
        try {
            selectedUnitImageView.setImage(
                    new Image(
            ...
            selectedUnitImageView.setImage(
                    new Image(
                            Main.class.getResource("/game/assets/civAsset/units/Units/Settler.png").toExternalForm()
                    )
            );
        }
